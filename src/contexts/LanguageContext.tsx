...
const translations = {
  en: {
    ...
    ourTruckFleet: "Our Truck Fleet",
    browseByCategory: "Browse our comprehensive inventory by category - from heavy-duty tractors to eco-friendly electric vehicles",
    viewCategory: "View Category",
    tractors: "Tractors",
    tractorsDesc: "Heavy-duty tractors for construction and industrial operations",
    dumpTrucks: "Dump Trucks",
    dumpTrucksDesc: "Reliable dump trucks for hauling and material transport",
    cargoTrucksDesc: "Versatile cargo trucks for freight and logistics",
    specialVehiclesDesc: "Specialized vehicles for unique operational needs",
    onroadTrucks: "On-road Trucks",
    onroadTrucksDesc: "Highway-ready trucks for long-distance transportation",
    newEnergyDesc: "Eco-friendly electric and hybrid commercial vehicles",
  ...
  fr: {
    ...
    ourTruckFleet: "Notre Flotte de Camions",
    browseByCategory: "Parcourez notre inventaire complet par catégorie - des tracteurs lourds aux véhicules électriques écologiques",
    viewCategory: "Voir la Catégorie",
    tractors: "Tracteurs",
    tractorsDesc: "Tracteurs lourds pour la construction et les opérations industrielles",
    dumpTrucks: "Camions Bennes",
    dumpTrucksDesc: "Camions bennes fiables pour le transport de matériaux",
    cargoTrucksDesc: "Camions polyvalents pour le fret et la logistique",
    specialVehiclesDesc: "Véhicules spécialisés pour des besoins opérationnels uniques",
    onroadTrucks: "Camions Routiers",
    onroadTrucksDesc: "Camions prêts pour l'autoroute pour le transport longue distance",
    newEnergyDesc: "Véhicules commerciaux électriques et hybrides écologiques",
